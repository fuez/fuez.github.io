...
## [About three dashes](https://stackoverflow.com/questions/50788277/why-3-dashes-hyphen-in-yaml-file)
> It's not mandatory to have them if you do not begin your YAML with a directive. If it's the case, you should use them.
> To signal the document start after directives, i.e., %YAML or %TAG lines according to the current spec.
> To signal the document start when you have multiple yaml documents in the same stream.
